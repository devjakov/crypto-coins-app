...
export const getCoins = (currency) => async (dispatch) => {
    ...
    try {
        const request = axios.get(`${base}/coins/markets?vs_currency=${currency}&order=market_cap_desc&per_page=20&page=1&sparkline=true&price_change_percentage=1h%2C24h%2C7d`);
